...
cat << EOF > draw_diftrend_sig_r1_50_mon_N30_90.f90
PROGRAM DRAW_DifTrend_Sig95_90_r1_50_mon_N30_90

! トレンド(trend)と有意性(sig95_90)をDCLで重ね描きするプログラム (北極点中心に、北緯30-90度域を描画)
! 1960~2014年1月
!
! Compile this program with the following way ;
! % dclfrt draw_diftrend_sig_r1_50_mon_N30_90.f90 -fconvert=big-endian && ./a.out
!--------------------------------------------------------------
...
!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-
      CHARACTER ( LEN = 200 ) :: OFILE = 'diftrend_sig9590.MIROC${runnum}-Hades_${yr}_${mon}_N30_90' ! output file name
...
END PROGRAM DRAW_DifTrend_Sig95_90_r1_50_mon_N30_90
EOF

dclfrt draw_diftrend_sig_r1_50_mon_N30_90.f90 && ./a.out                                               # DCLで描画する際は、little-endianでコンパイルする(draw_trend.sig.f90内で、gtoolのみbig-endian指定する) 
rm a.out GTAXLOC* 
mv ./draw_diftrend_sig_r1_50_mon_N30_90.f90 /home/honoka/work/HadCRUT5_MIROC6/diftrend/src/            # fortranファイルをsrcに移動 
mv ./diftrend_sig9590.MIROC${runnum}-Hades_${yr}_${mon}_N30_90 ${LTOP}/N30_90/diftrend_MIROC-Hades_${yr}_${mon}/  # 出力ファイルをdataに移動
