...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1
      ...
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'diftrend_MIROC6es-Hades_1960_2014_12'             ! input file name (1960~2014年のトレンドの差)
      CHARACTER ( LEN = 200 ) :: IFILE4 = 'MIROC6_ensm_sig95_90_trend.1_50_1960_2014_12_mon'    ! input file name (1960~2014年 全期間の有意性：有意水準10%,5%)

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-
      CHARACTER ( LEN = 200 ) :: OFILE = 'diftrend_sig9590_MIROCes-Hades_1960_2014_12_N30_90'    ! output file name

      character( len = * ), parameter :: title = "diftrend/sig95_90 es 12"
