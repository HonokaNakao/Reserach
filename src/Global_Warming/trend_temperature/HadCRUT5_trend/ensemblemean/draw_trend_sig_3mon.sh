...
#strmon=$1
#mon3='060708'                                         # MAM(030405), JJA(060708), SON(091011), DJF(120102)
mon3=$1                                                # MAM(030405), JJA(060708), SON(091011), DJF(120102)
...
cat << EOF > draw_trend_sig_3mon.f90
...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1
      ...
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'trend_1960_2014_${mon3}_mon'           ! input file name (トレンド)
      CHARACTER ( LEN = 200 ) :: IFILE4 = 'sig95_90_trend_1960_2014_${mon3}_mon'  ! input file name (有意性：有意水準10%,5%)

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-
      CHARACTER ( LEN = 200 ) :: OFILE = 'trend_sig9590_1960_2014_${mon3}_mon'  ! output file name

      character( len = * ), parameter :: title = "trend/sig95_90 1960-2014 ${mon3}"
...
dclfrt draw_trend_sig_3mon.f90 && ./a.out                            # DCLで描画する際は、little-endianでコンパイルする(draw_trend.sig.f90内で、gtoolのみbig-endian指定する) 

rm a.out GTAXLOC* 
mv ./draw_trend_sig_3mon.f90 ${LTOP}/src/t_test/t_test_ensemblemean/                           # fortranファイルをsrcに移動  
