...
cat << EOF > cal_trend_T_sig_mon.f90
...
!  INTEGER, PARAMETER :: MMAX= 660   ! No. of months (1960-2014年660個の月別データ)
  ...
  REAL :: block1( IMAX, JMAX )       ! sigma(xi*yi) (分子1項目)
...
!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789- 
  ...
  CHARACTER ( LEN = 200 ) :: OFILE3 = 'tval90_trend_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE4 = 'sig90_trend_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE5 = 'tval95_trend_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE6 = 'sig95_trend_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE7 = 'sig95_90_trend_1960_2014_${strmon}_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE8 = 'sigmae_trend_1960_2014_${strmon}_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE9 = 'esty_trend_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE10 = 'x_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE11 = 'sumx_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE12 = 'sumy_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE13 = 'ndata_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE14 = 'avex_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE15 = 'avey_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE16 = 'xx_1960_2014_${strmon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE17 = 'block1_1960_2014_${strmon}_mon'  ! output file name
...
!  trend(:,:) = 10.0*( block1(:,:) - ndata(:,:)*avex(:,:)*avey(:,:) ) / (xx(:,:) - ndata(:,:)*avex(:,:)*avex(:,:))  ! 10*[K/yr] -> [K/decade]
  ...
  OPEN ( 31, FILE=OFILE10, FORM='UNFORMATTED' ) ! open output file
  WRITE( 31 ) HEAD
  WRITE( 31 ) x
  CLOSE( 31 ) ! close output file

  OPEN ( 32, FILE=OFILE11, FORM='UNFORMATTED' ) ! open output file
  WRITE( 32 ) HEAD
  WRITE( 32 ) sumx
  CLOSE( 32 ) ! close output file

  OPEN ( 33, FILE=OFILE12, FORM='UNFORMATTED' ) ! open output file
  WRITE( 33 ) HEAD
  WRITE( 33 ) sumy
  CLOSE( 33 ) ! close output file

  OPEN ( 34, FILE=OFILE13, FORM='UNFORMATTED' ) ! open output file
  WRITE( 34 ) HEAD
  WRITE( 34 ) ndata
  CLOSE( 34 ) ! close output file

  OPEN ( 35, FILE=OFILE14, FORM='UNFORMATTED' ) ! open output file
  WRITE( 35 ) HEAD
  WRITE( 35 ) avex
  CLOSE( 35 ) ! close output file

  OPEN ( 36, FILE=OFILE15, FORM='UNFORMATTED' ) ! open output file
  WRITE( 36 ) HEAD
  WRITE( 36 ) avey
  CLOSE( 36 ) ! close output file

  OPEN ( 37, FILE=OFILE16, FORM='UNFORMATTED' ) ! open output file
  WRITE( 37 ) HEAD
  WRITE( 37 ) xx
  CLOSE( 37 ) ! close output file

  OPEN ( 38, FILE=OFILE17, FORM='UNFORMATTED' ) ! open output file
  WRITE( 38 ) HEAD
  WRITE( 38 ) block1
  CLOSE( 38 ) ! close output file
...
gfortran -fconvert=big-endian ./cal_trend_T_sig_mon.f90;./a.out > ${LTOP}/log/test_ver3.txt    # コンパイル & 実行 & 実行結果を確認 (redirection)

mv ./cal_trend_T_sig_mon.f90 ${LTOP}/src/t_test/t_test_ensemblemean/                           # fortranファイルをsrcに移動           
...
gtcont trend_1960_2014_${strmon}_mon tone=-10,-1,-0.6,-0.4,-0.2,-0.1,0.0,0.1,0.2,0.4,0.6,1.0,10 pat=10999,12999,22999,28999,48999,53999,58999,65999,70999,89999,97999,99999 map=1 -nocnt -print ps:trend_1960_2014_${strmon}_mon_rg-10_10.ps
...
gtcont sig95_90_trend_1960_2014_${strmon}_mon tone=85.0,90.0,95.0,100.0 pat=10999,53999,89999 map=1 -nocnt -print ps:sig95_90_trend_1960_2014_${strmon}_mon.ps
rm colormap.x11

# psファイルからpngファイルへ形式変更
convert -density 100 -rotate 90 trend_1960_2014_${strmon}_mon_rg-1_1.ps trend_1960_2014_${strmon}_mon_rg-1_1.png
convert -density 100 -rotate 90 trend_1960_2014_${strmon}_mon_rg-10_10.ps trend_1960_2014_${strmon}_mon_rg-10_10.png
convert -density 100 -rotate 90 sig95_90_trend_1960_2014_${strmon}_mon.ps sig95_90_trend_1960_2014_${strmon}_mon.png
