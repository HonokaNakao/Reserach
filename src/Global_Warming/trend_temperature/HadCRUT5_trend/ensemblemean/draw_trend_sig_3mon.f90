...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1
      ...
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'trend_1960_2014_060708_mon'           ! input file name (トレンド)
      CHARACTER ( LEN = 200 ) :: IFILE4 = 'sig95_90_trend_1960_2014_060708_mon'  ! input file name (有意性：有意水準10%,5%)

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-
      CHARACTER ( LEN = 200 ) :: OFILE = 'trend_sig9590_1960_2014_060708_mon'  ! output file name

      character( len = * ), parameter :: title = "trend/sig95_90 1960-2014 060708"
