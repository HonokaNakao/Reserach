...
cd ${LTOP}/data/data_ensemble_monthly/${DTOP}_1960_2014

#----------------------------------------------------------------------------
# 3ヶ月毎のディレクトリを作成
if [ ! -d ${DTOP}_${stryr}_${endyr}_${mon3} ] ; then
  mkdir ${LTOP}/data/data_ensemble_monthly/${DTOP}_${stryr}_${endyr}/${DTOP}_${stryr}_${endyr}_${mon3}
fi

cd ${LTOP}/data/data_ensemble_monthly/${DTOP}_${stryr}_${endyr}/${DTOP}_${stryr}_${endyr}_${mon3}/
cp ${LTOP}/data/data_ensemble_monthly/${DTOP}_${stryr}_${endyr}/${DTOP}_${stryr}_${endyr} ./
