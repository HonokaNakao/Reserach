...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1 
  CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT.5.0.1.0.analysis.anomalies.ensemble_mean_1960_2014_12' ! input file name

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789- 
  CHARACTER ( LEN = 200 ) :: OFILE = 'trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE2 = 'T_trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE3 = 'tval90_trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE4 = 'sig90_trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE5 = 'tval95_trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE6 = 'sig95_trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE7 = 'sig95_90_trend_1960_2014_12_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE8 = 'sigmae_trend_1960_2014_12_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE9 = 'esty_trend_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE10 = 'x_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE11 = 'sumx_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE12 = 'sumy_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE13 = 'ndata_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE14 = 'avex_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE15 = 'avey_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE16 = 'xx_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE17 = 'block1_1960_2014_12_mon'  ! output file name
...
!                trend(i,j) = 10.0*( block1(i,j) - ndata(i,j)*avex(i,j)*avey(i,j) ) / (xx(i,j) - ndata(i,j)*avex(i,j)*avex(i,j))  ! 10*[K/yr] -> [K/decade]
