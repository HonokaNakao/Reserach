...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1 
  CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT.5.0.1.0.analysis.anomalies.200_1960_2014_12' ! input file name

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789- 
  CHARACTER ( LEN = 200 ) :: OFILE = 'trend.200_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE2 = 'T_trend.2001960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE3 = 'tval90_trend.200_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE4 = 'sig90_trend.200_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE5 = 'tval95_trend.200_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE6 = 'sig95_trend.200_1960_2014_12_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE7 = 'sig95_90_trend.200_1960_2014_12_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE8 = 'sigmae_trend.200_1960_2014_12_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE9 = 'esty_trend.200_1960_2014_12_mon'  ! output file name
