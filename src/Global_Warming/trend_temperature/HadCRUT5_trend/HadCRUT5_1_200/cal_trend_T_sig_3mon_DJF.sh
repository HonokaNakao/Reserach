...
cd ${LTOP}/data/data_analysis_gridded_1_200/${DTOP}.${datanum}/${DTOP}.${datanum}_1960_2014/${DTOP}.${datanum}_1960_2014_${mon3}/   # GTOOLの在り処に移動
...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1 
  CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT.5.0.1.0.analysis.anomalies.${datanum}_1960_2014_${mon3}' ! input file name

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789- 
  CHARACTER ( LEN = 200 ) :: OFILE = 'trend.${datanum}_1960_2014_${mon3}_mon'             ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE2 = 'T_trend.${datanum}_1960_2014_${mon3}_mon'        ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE3 = 'tval90_trend.${datanum}_1960_2014_${mon3}_mon'   ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE4 = 'sig90_trend.${datanum}_1960_2014_${mon3}_mon'    ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE5 = 'tval95_trend.${datanum}_1960_2014_${mon3}_mon'   ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE6 = 'sig95_trend.${datanum}_1960_2014_${mon3}_mon'    ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE7 = 'sig95_90_trend.${datanum}_1960_2014_${mon3}_mon'   ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE8 = 'sigmae_trend.${datanum}_1960_2014_${mon3}_mon'   ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE9 = 'esty_trend.${datanum}_1960_2014_${mon3}_mon'     ! output file name
...
mv ./cal_trend_T_sig_3mon_DJF.f90 ${LTOP}/src/t_test/t_test_ensemble1_200/                           # fortranファイルをsrcに移動

## 描画
cd ${LTOP}/data/data_analysis_gridded_1_200/${DTOP}.${datanum}/${DTOP}.${datanum}_1960_2014/${DTOP}.${datanum}_1960_2014_${mon3}               # GTOOLの在り処に移動
gtcont trend.${datanum}_1960_2014_${mon3}_mon map=1 color=50 -nocnt -print ps:trend.${datanum}_1960_2014_${mon3}_mon.ps
...
gtcont trend.${datanum}_1960_2014_${mon3}_mon tone=-1,-0.6,-0.4,-0.2,-0.1,0.0,0.1,0.2,0.4,0.6,1.0 pat=10999,22999,28999,48999,53999,58999,65999,70999,89999,99999 map=1 -nocnt -print ps:trend.${datanum}_1960_2014_${mon3}_mon_rg-1_1.ps
#gtcont sig90_trend.${datanum}_1960_2014_${mon3}_mon tone=-1,-0.6,-0.4,-0.2,-0.1,0.0,0.1,0.2,0.4,0.6,1.0 pat=10999,22999,28999,48999,53999,58999,65999,70999,89999,99999 map=1 -nocnt -print ps:sig90_trend.${datanum}_1960_2014_${mon3}_mon_rg-1_1.ps
#gtcont sig95_trend.${datanum}_1960_2014_${mon3}_mon tone=-1,-0.6,-0.4,-0.2,-0.1,0.0,0.1,0.2,0.4,0.6,1.0 pat=10999,22999,28999,48999,53999,58999,65999,70999,89999,99999 map=1 -nocnt -print ps:sig95_trend.${datanum}_1960_2014_${mon3}_mon_rg-1_1.ps
gtcont sig95_90_trend.${datanum}_1960_2014_${mon3}_mon tone=85.0,90.0,95.0,100.0 pat=10999,53999,89999 map=1 -nocnt -print ps:sig95_90_trend.${datanum}_1960_2014_${mon3}_mon.ps
rm colormap.x11

# psファイルからpngファイルへ形式変更
convert -density 100 -rotate 90 trend.${datanum}_1960_2014_${mon3}_mon_rg-1_1.ps trend.${datanum}_1960_2014_${mon3}_mon_rg-1_1.png
convert -density 100 -rotate 90 sig95_90_trend.${datanum}_1960_2014_${mon3}_mon.ps sig95_90_trend.${datanum}_1960_2014_${mon3}_mon.png
