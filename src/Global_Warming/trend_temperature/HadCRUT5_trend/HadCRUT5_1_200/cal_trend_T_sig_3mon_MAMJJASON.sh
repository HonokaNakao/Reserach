...
cat << EOF > cal_trend_T_sig_3mon_MAMJJASON.f90
PROGRAM cal_trend_T_sig_3mon_MAMJJASON

! gfortran -fconvert=big-endian cal_trend_T_sig_3mon_MAMJJASON.f90
...
gfortran -fconvert=big-endian ./cal_trend_T_sig_3mon_MAMJJASON.f90;./a.out > ${LTOP}/log/test_ver3.txt    # コンパイル & 実行 & 実行結果を確認 (redirection)
mv ./cal_trend_T_sig_3mon_MAMJJASON.f90 ${LTOP}/src/t_test/t_test_ensemble1_200/                           # fortranファイルをsrcに移動
