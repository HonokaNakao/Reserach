...
!  INTEGER, PARAMETER :: MMAX= 165   ! No. of months (1960-2014の年55年×3ヶ月=165個の月別データ, MAM.JJA.SON)
  ...
  IF ( 12 == 12 ) THEN
     YMAX= 54    ! No. of years  (1961-2014年=54年, DJFの場合)
     MMAX= 162   ! No. of months (1960-2014の年54年×3ヶ月=162個の月別データ, DJF)
  ELSE
     YMAX= 55    ! No. of years  (1960-2014年=55年, MAM,JJA,SONの場合)
     MMAX= 165   ! No. of months (1960-2014の年55年×3ヶ月=165個の月別データ, MAM.JJA.SON)
  END IF
...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1 
  CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT.5.0.1.0.analysis.anomalies.2_1960_2014_120102' ! input file name

!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789- 
  CHARACTER ( LEN = 200 ) :: OFILE = 'trend.2_1960_2014_120102_mon'             ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE2 = 'T_trend.2_1960_2014_120102_mon'        ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE3 = 'tval90_trend.2_1960_2014_120102_mon'   ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE4 = 'sig90_trend.2_1960_2014_120102_mon'    ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE5 = 'tval95_trend.2_1960_2014_120102_mon'   ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE6 = 'sig95_trend.2_1960_2014_120102_mon'    ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE7 = 'sig95_90_trend.2_1960_2014_120102_mon'   ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE8 = 'sigmae_trend.2_1960_2014_120102_mon'   ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE9 = 'esty_trend.2_1960_2014_120102_mon'     ! output file name
