...
#    (例) MIROC6_T2_run1_50_anomalies_ensemble_1960_2014_030405 -> MIROC6 ensemble meanの1960年-2014年MAM
#
...
cat << EOF > cal_ensm_trend_T_sig_3mon_MAMJJASON.f90
PROGRAM cal_ensm_trend_T_sig_3mon_MAMJJASON

! gfortran -fconvert=big-endian cal_ensm_trend_T_sig_3mon_MAMJJASON.f90
...
gfortran -fconvert=big-endian ./cal_ensm_trend_T_sig_3mon_MAMJJASON.f90;./a.out > ${LTOP}/log/test_ver2.txt    # コンパイル & 実行 & 実行結果を確認 (redirection)
mv ./cal_ensm_trend_T_sig_3mon_MAMJJASON.f90 ${LTOP}/src/                                                      # fortranファイルをsrcに移動
