...
#    (例) MIROC6_T2_run1_anomalies_1960_2014_030405 -> 1960年-2014年MAMのデータ
#
...
gfortran -fconvert=big-endian ./cal_trend_T_sig_3mon_MAMJJASON.f90;./a.out > ${LTOP}/log/test_ver2.txt    # コンパイル & 実行 & 実行結果を確認 (redirection)
mv ./cal_trend_T_sig_3mon_MAMJJASON.f90 ${LTOP}/src/                                                      # fortranファイルをsrcに移動
