...
!! 出力ファイル名を指定               123456789-123456789-123456789-123456789-123456789- 
  CHARACTER ( LEN = 200 ) :: OFILE = 'MIROC6_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE2 = 'MIROC6_T_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE3 = 'MIROC6_tval90_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE4 = 'MIROC6_sig90_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE5 = 'MIROC6_tval95_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE6 = 'MIROC6_sig95_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
  CHARACTER ( LEN = 200 ) :: OFILE7 = 'MIROC6_sig95_90_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE8 = 'MIROC6_sigmae_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
!  CHARACTER ( LEN = 200 ) :: OFILE9 = 'MIROC6_esty_trend.${runnum}_1960_2014_${mon}_mon'  ! output file name
...
gfortran -fconvert=big-endian ./cal_trend_T_sig_mon.f90;./a.out > ${LTOP}/log/test_ver1.txt    # コンパイル & 実行 & 実行結果を確認 (redirection)

mv ./cal_trend_T_sig_mon.f90 ${LTOP}/src/                                                      # fortranファイルをsrcに移動           
...
# trend
gtcont MIROC6_trend.${runnum}_1960_2014_${mon}_mon tone=-1,-0.6,-0.4,-0.2,-0.1,0.0,0.1,0.2,0.4,0.6,1.0 pat=10999,22999,28999,48999,53999,58999,65999,70999,89999,99999 map=1 -nocnt -print ps:MIROC6_trend.${runnum}_1960_2014_${mon}_mon_rg-1_1.ps
gtcont MIROC6_trend.${runnum}_1960_2014_${mon}_mon tone=-10.0,-1.0,-0.6,-0.4,-0.2,-0.1,0.0,0.1,0.2,0.4,0.6,1.0,10.0 pat=10999,12999,22999,28999,48999,53999,58999,65999,70999,89999,97999,99999 map=1 -nocnt -print ps:MIROC6_trend.${runnum}_1960_2014_${mon}_mon_rg-10_10.ps
# sig95_90
gtcont MIROC6_sig95_90_trend.${runnum}_1960_2014_${mon}_mon tone=85.0,90.0,95.0,100.0 pat=10999,53999,89999 map=1 -nocnt -print ps:MIROC6_sig95_90_trend.${runnum}_1960_2014_${mon}_mon.ps
rm colormap.x11

# psファイルからpngファイルへ形式変更
convert -density 100 -rotate 90 MIROC6_trend.${runnum}_1960_2014_${mon}_mon_rg-1_1.ps MIROC6_trend.${runnum}_1960_2014_${mon}_mon_rg-1_1.png
convert -density 100 -rotate 90 MIROC6_trend.${runnum}_1960_2014_${mon}_mon_rg-10_10.ps MIROC6_trend.${runnum}_1960_2014_${mon}_mon_rg-10_10.png

convert -density 100 -rotate 90 MIROC6_sig95_90_trend.${runnum}_1960_2014_${mon}_mon.ps MIROC6_sig95_90_trend.${runnum}_1960_2014_${mon}_mon.png
