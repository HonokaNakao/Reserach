...
cd ${LTOP}/${DTOP}/${DTOP}_${mon}/                           # GTOOLの在り処に移動 (1-12月 月毎のtrend,sig95_90)
...
!      CHARACTER ( LEN = 200 ) :: IFILE3 = 'trend_1960_2014_mon'                             ! input file name (1960~2014年 全期間のトレンド)
      CHARACTER ( LEN = 200 ) :: IFILE3 = '${strnm}_trend.1_50_${yr}_${mon}_mon'             ! input file name (1960~2014年 月毎のトレンド)
...
!      CHARACTER ( LEN = 200 ) :: OFILE = 'trend_sig9590_1960_2014_mon'             ! output file name
      CHARACTER ( LEN = 200 ) :: OFILE = '${strnm}_trend_sig9590_1960_2014_${mon}_mon_NP'       ! output file name

      character( len = * ), parameter :: title = "${strnm} trend/sig95_90 1960-2014 ${mon}"
...
rm a.out GTAXLOC* 
mv ./draw_trend_sig_mon_NP.f90 /home/honoka/work/MIROC6/src/            # fortranファイルをsrcに移動 

# 画像の切り取り (convert)
convert -density 100 -crop 664x470+110+40 ${strnm}_trend_sig9590_1960_2014_${mon}_mon_NP ${strnm}_trend_sig9590_${mon}_NP
