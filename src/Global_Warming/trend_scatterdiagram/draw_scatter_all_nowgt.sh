...
# 空間相関 (面積の重み付けなし)--------------------------------------------------------------------------------------------
ln -s ${LTOP2}/sppattern_Hadav-MIROC_030405_${area}_nowgt.txt                        # MAM
ln -s ${LTOP2}/sppattern_Hadav-MIROC_060708_${area}_nowgt.txt                        # JJA
ln -s ${LTOP2}/sppattern_Hadav-MIROC_091011_${area}_nowgt.txt                        # SON
ln -s ${LTOP2}/sppattern_Hadav-MIROC_120102_${area}_nowgt.txt                        # DJF
...
## 空間相関の度数分布表をDCLで描画
cat << EOF > draw_scatter_all_nowgt.f90
...
!! 入力ファイル名を指定
! 空間相関 (面積の重み付けなし)
      CHARACTER ( LEN = 200 ) :: IFILE10 = 'sppattern_Hadav-MIROC_030405_${area}_nowgt.txt'      ! MAM
      CHARACTER ( LEN = 200 ) :: IFILE11 = 'sppattern_Hadav-MIROC_060708_${area}_nowgt.txt'      ! JJA
      CHARACTER ( LEN = 200 ) :: IFILE12 = 'sppattern_Hadav-MIROC_091011_${area}_nowgt.txt'      ! SON
      CHARACTER ( LEN = 200 ) :: IFILE13 = 'sppattern_Hadav-MIROC_120102_${area}_nowgt.txt'      ! DJF
...
!! 出力ファイル名を指定
      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_${area}_nowgt'   ! output file name 
...
mv ./scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_${area}_nowgt ${LTOP5}/data/${area}/ 
#mv ./draw_scatter_all_nowgt.f90 ${LTOP5}/src/

# シンボリックリンクを削除
# 空間相関(面積重み付けなし)
# HadCRUT5 アンサンブル平均
rm ${LTOP5}/src/sppattern_Hadav-MIROC_030405_${area}_nowgt.txt 
rm ${LTOP5}/src/sppattern_Hadav-MIROC_060708_${area}_nowgt.txt 
rm ${LTOP5}/src/sppattern_Hadav-MIROC_091011_${area}_nowgt.txt 
rm ${LTOP5}/src/sppattern_Hadav-MIROC_120102_${area}_nowgt.txt 
