...
# ensemble meanをtrendのアンサンブル平均に差し替え
# 空間相関 (面積の重み付けあり)
# MAM,JJA,SON,DJF
# 2024.1.21作成
...
# 空間相関 (面積の重み付けあり 2024.1.21修正版)----------------------------------------------------------------------------
ln -s ${LTOP2}/sppatternwgt_Hadav-MIROC_030405_${area}_240121v.txt                   # MAM
ln -s ${LTOP2}/sppatternwgt_Hadav-MIROC_060708_${area}_240121v.txt                   # JJA
ln -s ${LTOP2}/sppatternwgt_Hadav-MIROC_091011_${area}_240121v.txt                   # SON
ln -s ${LTOP2}/sppatternwgt_Hadav-MIROC_120102_${area}_240121v.txt                   # DJF

# 領域平均値---------------------------------------------------------------------------------------------------------------
# HadCRUT5 1-200のアンサンブル
ln -s ${LTOP4}/HadCRUT5_1_200av_trendwgtav_1960_2014_030405_${area}.txt              # MAM
ln -s ${LTOP4}/HadCRUT5_1_200av_trendwgtav_1960_2014_060708_${area}.txt              # JJA
ln -s ${LTOP4}/HadCRUT5_1_200av_trendwgtav_1960_2014_091011_${area}.txt              # SON
ln -s ${LTOP4}/HadCRUT5_1_200av_trendwgtav_1960_2014_120102_${area}.txt              # DJF

# MIROC6 run1-50のアンサンブル
ln -s ${LTOP4}/MIROC6r1_50av_trendwgtav_1960_2014_030405_${area}.txt                 # MAM
ln -s ${LTOP4}/MIROC6r1_50av_trendwgtav_1960_2014_060708_${area}.txt                 # JJA
ln -s ${LTOP4}/MIROC6r1_50av_trendwgtav_1960_2014_091011_${area}.txt                 # SON
ln -s ${LTOP4}/MIROC6r1_50av_trendwgtav_1960_2014_120102_${area}.txt                 # DJF

# MIROC run1-50
ln -s ${LTOP4}/MIROC6_r1-50_trendwgtav_1960_2014_030405_${area}.txt                  # MAM
ln -s ${LTOP4}/MIROC6_r1-50_trendwgtav_1960_2014_060708_${area}.txt                  # MAM
ln -s ${LTOP4}/MIROC6_r1-50_trendwgtav_1960_2014_091011_${area}.txt                  # MAM
ln -s ${LTOP4}/MIROC6_r1-50_trendwgtav_1960_2014_120102_${area}.txt                  # MAM


## 空間相関と領域平均値の散布図をDCLで描画
## 空間相関の度数分布表をDCLで描画
cat << EOF > draw_scatter_all_wgt.f90
PROGRAM Draw_Scatter_diagram

! 空間相関と領域平均値の散布図を描画するプログラム
!
! Compile this program with the following way ;
! % dclfrt draw_scatter_all_wgt.f90 -g && ./a.out
!--------------------------------------------------------------
...
!      REAL, PARAMETER    :: ymax = 0.5                             ! 散布図 縦軸(y軸)の上限
      REAL, PARAMETER    :: ymin = -0.2                             ! 散布図 縦軸(y軸)の下限
      REAL, PARAMETER    :: ymax = 0.2                              ! 散布図 縦軸(y軸)の上限
      INTEGER, PARAMETER :: ndata = 50                              ! 空間相関　データ総数
!      REAL, PARAMETER    :: xmin = -0.5                            ! 空間相関　横軸(x軸)の下限
      REAL, PARAMETER    :: xmin = 0.0                              ! 空間相関　横軸(x軸)の下限
...
!! 入力ファイル名を指定
! 空間相関 (面積の重み付けあり 2024.1.21修正版)
      CHARACTER ( LEN = 200 ) :: IFILE10 = 'sppatternwgt_Hadav-MIROC_030405_${area}_240121v.txt'          ! MAM
      CHARACTER ( LEN = 200 ) :: IFILE11 = 'sppatternwgt_Hadav-MIROC_060708_${area}_240121v.txt'          ! JJA
      CHARACTER ( LEN = 200 ) :: IFILE12 = 'sppatternwgt_Hadav-MIROC_091011_${area}_240121v.txt'          ! SON
      CHARACTER ( LEN = 200 ) :: IFILE13 = 'sppatternwgt_Hadav-MIROC_120102_${area}_240121v.txt'          ! DJF

! 領域平均値------------------------------------------------------------------------------------
! HadCRUT5 アンサンブル平均
      CHARACTER ( LEN = 200 ) :: IFILE20 = 'HadCRUT5_1_200av_trendwgtav_1960_2014_030405_${area}.txt'     ! MAM
      CHARACTER ( LEN = 200 ) :: IFILE21 = 'HadCRUT5_1_200av_trendwgtav_1960_2014_060708_${area}.txt'     ! JJA
      CHARACTER ( LEN = 200 ) :: IFILE22 = 'HadCRUT5_1_200av_trendwgtav_1960_2014_091011_${area}.txt'     ! SON
      CHARACTER ( LEN = 200 ) :: IFILE23 = 'HadCRUT5_1_200av_trendwgtav_1960_2014_120102_${area}.txt'     ! DJF

! MIROC6 アンサンブル平均
      CHARACTER ( LEN = 200 ) :: IFILE30 = 'MIROC6r1_50av_trendwgtav_1960_2014_030405_${area}.txt'        ! MAM
      CHARACTER ( LEN = 200 ) :: IFILE31 = 'MIROC6r1_50av_trendwgtav_1960_2014_060708_${area}.txt'        ! JJA
      CHARACTER ( LEN = 200 ) :: IFILE32 = 'MIROC6r1_50av_trendwgtav_1960_2014_091011_${area}.txt'        ! SON
      CHARACTER ( LEN = 200 ) :: IFILE33 = 'MIROC6r1_50av_trendwgtav_1960_2014_120102_${area}.txt'        ! DJF

! MIROC6 run1-50
      CHARACTER ( LEN = 200 ) :: IFILE40 = 'MIROC6_r1-50_trendwgtav_1960_2014_030405_${area}.txt'         ! MAM
      CHARACTER ( LEN = 200 ) :: IFILE41 = 'MIROC6_r1-50_trendwgtav_1960_2014_060708_${area}.txt'         ! JJA
      CHARACTER ( LEN = 200 ) :: IFILE42 = 'MIROC6_r1-50_trendwgtav_1960_2014_091011_${area}.txt'         ! SON
      CHARACTER ( LEN = 200 ) :: IFILE43 = 'MIROC6_r1-50_trendwgtav_1960_2014_120102_${area}.txt'         ! DJF

!! 出力ファイル名を指定
!      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_${area}_wgt_24012v'       ! output file name (アンサンブル平均の点線あり)
      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_${area}_wgt_24012v_noes'   ! output file name (アンサンブル平均の点線なし)
      CHARACTER( LEN = * ), PARAMETER :: title = "Hadav-MIROC_${area} MJSD"                   ! 図のタイトル 
...
!      CALL SGLAZU( patnes4, yesm, patnes4, 100.0, 3, 41)                      ! HadCRUT5 ensemble meanとMIROC ensemble meanの空間相関 ( 青点線 ) : DJF           
      ...
      CALL SGLAZU( xmin, xmin, 100.0, xmin, 3, 11)                               ! 領域平均値の差 = 0.0 (黒点線)
...
#mv ./scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_${area}_wgt_24012v ${LTOP5}/data/${area}/ 
mv ./scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_${area}_wgt_24012v_noes ${LTOP5}/data/${area}/ 

# シンボリックリンクを削除
# 空間相関(面積重み付けあり)
# HadCRUT5 アンサンブル平均
rm ${LTOP5}/src/sppatternwgt_Hadav-MIROC_030405_${area}_240121v.txt 
rm ${LTOP5}/src/sppatternwgt_Hadav-MIROC_060708_${area}_240121v.txt 
rm ${LTOP5}/src/sppatternwgt_Hadav-MIROC_091011_${area}_240121v.txt 
rm ${LTOP5}/src/sppatternwgt_Hadav-MIROC_120102_${area}_240121v.txt 

# 領域平均値
# HadCRUT5 アンサンブル平均
rm ${LTOP5}/src/HadCRUT5_1_200av_trendwgtav_1960_2014_030405_${area}.txt
rm ${LTOP5}/src/HadCRUT5_1_200av_trendwgtav_1960_2014_060708_${area}.txt
rm ${LTOP5}/src/HadCRUT5_1_200av_trendwgtav_1960_2014_091011_${area}.txt
rm ${LTOP5}/src/HadCRUT5_1_200av_trendwgtav_1960_2014_120102_${area}.txt

# MIROC6 アンサンブル平均
rm ${LTOP5}/src/MIROC6r1_50av_trendwgtav_1960_2014_030405_${area}.txt
rm ${LTOP5}/src/MIROC6r1_50av_trendwgtav_1960_2014_060708_${area}.txt
rm ${LTOP5}/src/MIROC6r1_50av_trendwgtav_1960_2014_091011_${area}.txt
rm ${LTOP5}/src/MIROC6r1_50av_trendwgtav_1960_2014_120102_${area}.txt

# MIROC6 run1-50
rm ${LTOP5}/src/MIROC6_r1-50_trendwgtav_1960_2014_030405_${area}.txt
rm ${LTOP5}/src/MIROC6_r1-50_trendwgtav_1960_2014_060708_${area}.txt
rm ${LTOP5}/src/MIROC6_r1-50_trendwgtav_1960_2014_091011_${area}.txt
rm ${LTOP5}/src/MIROC6_r1-50_trendwgtav_1960_2014_120102_${area}.txt
