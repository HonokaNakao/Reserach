...
! 空間相関 (面積の重み付けあり 2024.1.21修正版)
      CHARACTER ( LEN = 200 ) :: IFILE10 = 'sppatternwgt_Hadav-MIROC_030405_N30_90_240121v.txt'          ! MAM
      CHARACTER ( LEN = 200 ) :: IFILE11 = 'sppatternwgt_Hadav-MIROC_060708_N30_90_240121v.txt'          ! JJA
      CHARACTER ( LEN = 200 ) :: IFILE12 = 'sppatternwgt_Hadav-MIROC_091011_N30_90_240121v.txt'          ! SON
      CHARACTER ( LEN = 200 ) :: IFILE13 = 'sppatternwgt_Hadav-MIROC_120102_N30_90_240121v.txt'          ! DJF
...
!! 出力ファイル名を指定
!      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_N30_90_wgt_24012v'       ! output file name (アンサンブル平均の点線あり)
      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppattern-trendwgtav_Hadav-MIROC_allseason_N30_90_wgt_24012v_noes'   ! output file name (アンサンブル平均の点線なし)
