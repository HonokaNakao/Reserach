...
ln -s ${LTOP2}/${var1}_Hades-MIROC_030405_${area}.txt                                # MAM
ln -s ${LTOP2}/${var1}_Hades-MIROC_060708_${area}.txt                                # JJA
ln -s ${LTOP2}/${var1}_Hades-MIROC_091011_${area}.txt                                # SON
ln -s ${LTOP2}/${var1}_Hades-MIROC_120102_${area}.txt                                # DJF

# 領域平均値
# HadCRUT5 ensemble mean
#ln -s ${LTOP4}/HadCRUT5es_${var2}_1960_2014_${mon}_${area}.txt                       # HadCRUT5 ensemble mean
ln -s ${LTOP4}/HadCRUT5es_${var2}_1960_2014_030405_${area}.txt                       # HadCRUT5 ensemble mean (MAM)
ln -s ${LTOP4}/HadCRUT5es_${var2}_1960_2014_060708_${area}.txt                       # HadCRUT5 ensemble mean (JJA)
ln -s ${LTOP4}/HadCRUT5es_${var2}_1960_2014_091011_${area}.txt                       # HadCRUT5 ensemble mean (SON)
ln -s ${LTOP4}/HadCRUT5es_${var2}_1960_2014_120102_${area}.txt                       # HadCRUT5 ensemble mean (DJF)

# MIROC6 ensemble mean
#ln -s ${LTOP4}/MIROC6es_${var2}_1960_2014_${mon}_${area}.txt                         # MIROC6 ensemble mean
ln -s ${LTOP4}/MIROC6es_${var2}_1960_2014_030405_${area}.txt                         # MIROC6 ensemble mean (MAM)
ln -s ${LTOP4}/MIROC6es_${var2}_1960_2014_060708_${area}.txt                         # MIROC6 ensemble mean (JJA)
ln -s ${LTOP4}/MIROC6es_${var2}_1960_2014_091011_${area}.txt                         # MIROC6 ensemble mean (SON)
ln -s ${LTOP4}/MIROC6es_${var2}_1960_2014_120102_${area}.txt                         # MIROC6 ensemble mean (DJF)

# MIROC6 run1-50
#ln -s ${LTOP4}/MIROC6_r1-50_${var2}_1960_2014_${mon}_${area}.txt                     # MIROC6 run1-50
ln -s ${LTOP4}/MIROC6_r1-50_${var2}_1960_2014_030405_${area}.txt                     # MIROC6 run1-50 (MAM)
ln -s ${LTOP4}/MIROC6_r1-50_${var2}_1960_2014_060708_${area}.txt                     # MIROC6 run1-50 (JJA)
ln -s ${LTOP4}/MIROC6_r1-50_${var2}_1960_2014_091011_${area}.txt                     # MIROC6 run1-50 (SON)
ln -s ${LTOP4}/MIROC6_r1-50_${var2}_1960_2014_120102_${area}.txt                     # MIROC6 run1-50 (DJF)

## 空間相関と領域平均値の散布図をDCLで描画
## 空間相関の度数分布表をDCLで描画
cat << EOF > draw_scatter_all.f90
PROGRAM Draw_Scatter_diagram

! 空間相関と領域平均値の散布図を描画するプログラム
!
! Compile this program with the following way ;
! % dclfrt draw_scatter_all.f90 -g && ./a.out
!--------------------------------------------------------------
...
!      CHARACTER ( LEN = 200 ) :: IFILE = '${var1}_Hades-MIROC_${mon}_${area}.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE10 = '${var1}_Hades-MIROC_030405_${area}.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE11 = '${var1}_Hades-MIROC_060708_${area}.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE12 = '${var1}_Hades-MIROC_091011_${area}.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE13 = '${var1}_Hades-MIROC_120102_${area}.txt'               ! input file name ( 空間相関 )

!      CHARACTER ( LEN = 200 ) :: IFILE2 = 'HadCRUT5es_${var2}_1960_2014_${mon}_${area}.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE20 = 'HadCRUT5es_${var2}_1960_2014_030405_${area}.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE21 = 'HadCRUT5es_${var2}_1960_2014_060708_${area}.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE22 = 'HadCRUT5es_${var2}_1960_2014_091011_${area}.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE23 = 'HadCRUT5es_${var2}_1960_2014_120102_${area}.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )

!      CHARACTER ( LEN = 200 ) :: IFILE3 = 'MIROC6es_${var2}_1960_2014_${mon}_${area}.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE30 = 'MIROC6es_${var2}_1960_2014_030405_${area}.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE31 = 'MIROC6es_${var2}_1960_2014_060708_${area}.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE32 = 'MIROC6es_${var2}_1960_2014_091011_${area}.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE33 = 'MIROC6es_${var2}_1960_2014_120102_${area}.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )

!      CHARACTER ( LEN = 200 ) :: IFILE4 = 'MIROC6_r1-50_${var2}_1960_2014_${mon}_${area}.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE40 = 'MIROC6_r1-50_${var2}_1960_2014_030405_${area}.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE41 = 'MIROC6_r1-50_${var2}_1960_2014_060708_${area}.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE42 = 'MIROC6_r1-50_${var2}_1960_2014_091011_${area}.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE43 = 'MIROC6_r1-50_${var2}_1960_2014_120102_${area}.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )

!! 出力ファイル名を指定
!      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_${var1}-${var2}_Hades-MIROC_${mon}_${area}'   ! output file name 
      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_${var1}-${var2}_Hades-MIROC_allseason_${area}'   ! output file name 
!      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_${var1}-${var2}_Hadav-MIROC_allseason_${area}'   ! output file name 
!      CHARACTER( LEN = * ), PARAMETER :: title = "Hades-MIROC_${area} ${mon}"                   ! 図のタイトル 
      CHARACTER( LEN = * ), PARAMETER :: title = "Hades-MIROC_${area} MJSD"                   ! 図のタイトル 
...
mv ./scatter_${var1}-${var2}_Hades-MIROC_allseason_${area} ${LTOP5}/data/${area}/ 
mv ./draw_scatter_all.f90 ${LTOP5}/src/

# シンボリックリンクを削除
#rm ${LTOP5}/src/${var1}_Hades-MIROC_${mon}_${area}.txt 
rm ${LTOP5}/src/${var1}_Hades-MIROC_030405_${area}.txt 
rm ${LTOP5}/src/${var1}_Hades-MIROC_060708_${area}.txt 
rm ${LTOP5}/src/${var1}_Hades-MIROC_091011_${area}.txt 
rm ${LTOP5}/src/${var1}_Hades-MIROC_120102_${area}.txt 

rm ${LTOP5}/src/HadCRUT5es_${var2}_1960_2014_030405_${area}.txt
rm ${LTOP5}/src/HadCRUT5es_${var2}_1960_2014_060708_${area}.txt
rm ${LTOP5}/src/HadCRUT5es_${var2}_1960_2014_091011_${area}.txt
rm ${LTOP5}/src/HadCRUT5es_${var2}_1960_2014_120102_${area}.txt

rm ${LTOP5}/src/MIROC6es_${var2}_1960_2014_030405_${area}.txt
rm ${LTOP5}/src/MIROC6es_${var2}_1960_2014_060708_${area}.txt
rm ${LTOP5}/src/MIROC6es_${var2}_1960_2014_091011_${area}.txt
rm ${LTOP5}/src/MIROC6es_${var2}_1960_2014_120102_${area}.txt

rm ${LTOP5}/src/MIROC6_r1-50_${var2}_1960_2014_030405_${area}.txt
rm ${LTOP5}/src/MIROC6_r1-50_${var2}_1960_2014_060708_${area}.txt
rm ${LTOP5}/src/MIROC6_r1-50_${var2}_1960_2014_091011_${area}.txt
rm ${LTOP5}/src/MIROC6_r1-50_${var2}_1960_2014_120102_${area}.txt
