...
!! 入力ファイル名を指定
!      CHARACTER ( LEN = 200 ) :: IFILE = 'sppatternwgt_Hades-MIROC__N30_90.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE10 = 'sppatternwgt_Hades-MIROC_030405_N30_90.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE11 = 'sppatternwgt_Hades-MIROC_060708_N30_90.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE12 = 'sppatternwgt_Hades-MIROC_091011_N30_90.txt'               ! input file name ( 空間相関 )
      CHARACTER ( LEN = 200 ) :: IFILE13 = 'sppatternwgt_Hades-MIROC_120102_N30_90.txt'               ! input file name ( 空間相関 )

!      CHARACTER ( LEN = 200 ) :: IFILE2 = 'HadCRUT5es_trendwgtav_1960_2014__N30_90.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE20 = 'HadCRUT5es_trendwgtav_1960_2014_030405_N30_90.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE21 = 'HadCRUT5es_trendwgtav_1960_2014_060708_N30_90.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE22 = 'HadCRUT5es_trendwgtav_1960_2014_091011_N30_90.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE23 = 'HadCRUT5es_trendwgtav_1960_2014_120102_N30_90.txt'     ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )

!      CHARACTER ( LEN = 200 ) :: IFILE3 = 'MIROC6es_trendwgtav_1960_2014__N30_90.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE30 = 'MIROC6es_trendwgtav_1960_2014_030405_N30_90.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE31 = 'MIROC6es_trendwgtav_1960_2014_060708_N30_90.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE32 = 'MIROC6es_trendwgtav_1960_2014_091011_N30_90.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE33 = 'MIROC6es_trendwgtav_1960_2014_120102_N30_90.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )

!      CHARACTER ( LEN = 200 ) :: IFILE4 = 'MIROC6_r1-50_trendwgtav_1960_2014__N30_90.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE40 = 'MIROC6_r1-50_trendwgtav_1960_2014_030405_N30_90.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE41 = 'MIROC6_r1-50_trendwgtav_1960_2014_060708_N30_90.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE42 = 'MIROC6_r1-50_trendwgtav_1960_2014_091011_N30_90.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )
      CHARACTER ( LEN = 200 ) :: IFILE43 = 'MIROC6_r1-50_trendwgtav_1960_2014_120102_N30_90.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )

!! 出力ファイル名を指定
!      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppatternwgt-trendwgtav_Hades-MIROC__N30_90'   ! output file name 
      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppatternwgt-trendwgtav_Hades-MIROC_allseason_N30_90'   ! output file name 
!      CHARACTER ( LEN = 300 ) :: OFILE = 'scatter_sppatternwgt-trendwgtav_Hadav-MIROC_allseason_N30_90'   ! output file name 
!      CHARACTER( LEN = * ), PARAMETER :: title = "Hades-MIROC_N30_90 "                   ! 図のタイトル 
      CHARACTER( LEN = * ), PARAMETER :: title = "Hades-MIROC_N30_90 MJSD"                   ! 図のタイトル 
