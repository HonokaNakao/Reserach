...
gfortran -fconvert=big-endian ./cal_pattern.f90;./a.out > sppattern_Hades-MIROC_${mon}.txt
#gfortran -fconvert=big-endian ./cal_pattern.f90;./a.out

mv ./cal_pattern.f90 /home/honoka/work/sppattern/src/
mv ./sppattern_Hades-MIROC_${mon}.txt /home/honoka/work/sppattern/data/sppattern_Hades-MIROC/WG/
