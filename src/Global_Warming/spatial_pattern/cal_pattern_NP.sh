...
# MIROC6 ensemblemean & 50例とHadCRUT5 ensemblemean & 200例の空間相関を算出するプログラム (北半球 : 北緯2.5-87.5度)
#----------------------------------------------------------------------------------------------------------------------------------------------
...
! 欠損値以外のデータ総数
      numdt = 0.0
      DO k = 1297, KMAX                                       ! 北半球 (北緯2.5-87.5度)
...
# コンパイル & 出力ファイル指定
gfortran -fconvert=big-endian ./cal_pattern_NP.f90;./a.out > sppattern_Hades-MIROC_${mon}_NP.txt

mv ./cal_pattern_NP.f90 /home/honoka/work/sppattern/src/
mv ./sppattern_Hades-MIROC_${mon}_NP.txt /home/honoka/work/sppattern/data/sppattern_Hades-MIROC/NP/
