...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1
      CHARACTER ( LEN = 200 ) :: IFILE = 'ifnmMIROC_120102.txt'
      CHARACTER ( LEN = 200 ) :: IFILEHad ='HadCRUT5_ensm_trend_1960_2014_120102_mon'                    ! input file name : HadCRUT5 ensemble data
