...
LTOP=/home/honoka/work/sppattern/
LTOP2=/home/honoka/work/sppattern/data/sppattern_Hades-MIROC/${area}
cd ${LTOP2}                                                        # 空間相関データの在り処に移動
...
!! 入力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: IFILE = 'sppattern_Hades-MIROC_${mon}_${area}.txt'       ! input file name

!! 出力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: OFILE = 'bar_sppattern_Hades-MIROC_${mon}_${area}'        ! output file name
      CHARACTER( LEN = * ), PARAMETER :: title = "sppattern_Hades-MIROC_${area} ${mon}"    ! 図のタイトル
...
mv ./bar_sppattern_Hades-MIROC_${mon}_${area} ./bar/
