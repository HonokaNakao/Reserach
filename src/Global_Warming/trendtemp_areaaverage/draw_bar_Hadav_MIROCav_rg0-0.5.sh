...
cat << EOF > draw_bar_Hadav_MIROCav_rg0-0.5.f90
...
!! 出力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: OFILE = 'bar_trendwgtav_Hadav-MIROC_${mon}_${area}_rg0-0.5'      ! output file name (trend : 面積の重み付けあり)
...
# コンパイル & 出力ファイル指定
dclfrt ./draw_bar_Hadav_MIROCav_rg0-0.5.f90 -g && ./a.out

# 画像の切り取り (convert)
convert -density 100 -crop 498x525+166+75 bar_trendwgtav_Hadav-MIROC_${mon}_${area}_rg0-0.5 bar_trendwgtav_Hadav-MIROC_${mon}_${area}_rg0-0.5_ct

mv ./bar_trendwgtav_Hadav-MIROC_${mon}_${area}_rg0-0.5 ./bar/     # trend : 面積の重み付けあり
mv ./bar_trendwgtav_Hadav-MIROC_${mon}_${area}_rg0-0.5_ct ./bar/     # trend : 面積の重み付けあり
mv ./draw_bar_Hadav_MIROCav_rg0-0.5.f90 ${LTOP}/src/
