...
!! 入力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT5es_${var2}_1960_2014_${mon}_${area}.txt'      ! input file name ( 領域平均値 : HadCRUT5 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE2 = 'MIROC6es_${var2}_1960_2014_${mon}_${area}.txt'       ! input file name ( 領域平均値 : MIROC6 ensemble mean )
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'MIROC6_r1-50_${var2}_1960_2014_${mon}_${area}.txt'   ! input file name ( 領域平均値 : MIROC6 run1-50 )

!! 出力ファイル名を指定
      CHARACTER ( LEN = 300 ) :: OFILE = 'diftrendav_MIROC-Hades_${mon}_${area}.txt'            ! output file name 
...
# コンパイル
gfortran -fconvert=big-endian ./cal_diftrendwgtav.f90;./a.out

mv ./cal_diftrendwgtav.f90 /home/honoka/work/HadCRUT5_MIROC6/trendwgtav/src/ 
mv ./diftrendav_MIROC-Hades_${mon}_${area}.txt /home/honoka/work/HadCRUT5_MIROC6/trendwgtav/data/N30_90/diftrendwgtav_MIROC-Had/
