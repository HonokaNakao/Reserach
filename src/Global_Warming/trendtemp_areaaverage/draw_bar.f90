...
!! 入力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT5es_trendwgtav_1960_2014_120102_N30_90.txt'     ! input file name (trend : 面積の重み付けあり)
      CHARACTER ( LEN = 200 ) :: IFILE2 = 'MIROC6es_trendwgtav_1960_2014_120102_N30_90.txt'      ! input file name (trend : 面積の重み付けあり)
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'MIROC6_r1-50_trendwgtav_1960_2014_120102_N30_90.txt'  ! input file name (trend : 面積の重み付けあり)

!! 出力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: OFILE = 'bar_trendwgtav_Hades-MIROC_120102_N30_90'              ! output file name (trend : 面積の重み付けあり)
      CHARACTER( LEN = * ), PARAMETER :: title = "Hades-MIROC_N30_90 120102"          ! 図のタイトル (trend : 面積の重み付けあり)
