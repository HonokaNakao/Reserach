...
!! 入力ファイル名を指定               123456789-123456789-123456789-123456789-123456789-1
      CHARACTER ( LEN = 200 ) :: IFILE = 'ifnmMIROC2_120102.txt'                                    ! trendのensemble mean ver

      CHARACTER ( LEN = 200 ) :: IFILEHad ='HadCRUT5_trend_1_200av_1960_2014_120102'                ! input file name : HadCRUT5 ensemble data (trendのensemble mean)
...
!!　出力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: OFILE = 'MIROC6r1_50av_trendwgtav_1960_2014_120102_N30_90.txt'     ! MIROC ensemblemeanのtrendの面積重み付き領域平均値 (trendのensemble mean)

      CHARACTER ( LEN = 200 ) :: OFILE2 = 'MIROC6_r1-50_trendwgtav_1960_2014_120102_N30_90.txt'     ! MIROC run1_50のtrendの面積重み付き領域平均値

      CHARACTER ( LEN = 200 ) :: OFILE3 = 'HadCRUT5_1_200av_trendwgtav_1960_2014_120102_N30_90.txt' ! HadCRUT5 ensemblemeanのtrendの面積重み付き領域平均値 (trendのensemble mean)
