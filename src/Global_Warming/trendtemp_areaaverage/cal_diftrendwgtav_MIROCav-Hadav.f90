...
!! 入力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT5_1_200av_trendwgtav_1960_2014_120102_N30_90.txt'    ! input file name ( 領域平均値 : HadCRUT5 アンサンブル平均 )
      CHARACTER ( LEN = 200 ) :: IFILE2 = 'MIROC6r1_50av_trendwgtav_1960_2014_120102_N30_90.txt'      ! input file name ( 領域平均値 : MIROC6 アンサンブル平均 )
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'MIROC6_r1-50_trendwgtav_1960_2014_120102_N30_90.txt'       ! input file name ( 領域平均値 : MIROC6 run1-50 )

!! 出力ファイル名を指定
      CHARACTER ( LEN = 300 ) :: OFILE = 'diftrendav_MIROC-Hadav_120102_N30_90.txt'             ! output file name (アンサンブル平均 ver)
