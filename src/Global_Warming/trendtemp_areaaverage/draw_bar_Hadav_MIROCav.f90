...
!! 入力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: IFILE = 'HadCRUT5_1_200av_trendwgtav_1960_2014_1_N30_90.txt'     ! input file name (trend : 面積の重み付けあり)
      CHARACTER ( LEN = 200 ) :: IFILE2 = 'MIROC6r1_50av_trendwgtav_1960_2014_1_N30_90.txt'       ! input file name (trend : 面積の重み付けあり)
      CHARACTER ( LEN = 200 ) :: IFILE3 = 'MIROC6_r1-50_trendwgtav_1960_2014_1_N30_90.txt'        ! input file name (trend : 面積の重み付けあり)

!! 出力ファイル名を指定
      CHARACTER ( LEN = 200 ) :: OFILE = 'bar_trendwgtav_Hadav-MIROC_1_N30_90_rg0-0.5'      ! output file name (trend : 面積の重み付けあり)
      CHARACTER( LEN = * ), PARAMETER :: title = "1"                                         ! 図のタイトル (trend : 面積の重み付けあり)
